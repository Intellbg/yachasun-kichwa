  ...
  return (
    <div className="container">
      ...
      <div className={`${!((5 < level)) ? "d-none" : ""} text-center`}>
        <h1>¡Felicitaciones ya ha completado el módulo 1 del nivel básico!</h1>
        <img
        ...
        <div className="m-auto text-center">
          <a href={`/lectures/basic/es/greetings-farewells`} className={`text-center btn btn-success ${(5 < level) | isAnswerCorrect ? "" : "d-none m-auto"}`}>Continuar</a>
        </div>
      </div>
    </div>
  );
