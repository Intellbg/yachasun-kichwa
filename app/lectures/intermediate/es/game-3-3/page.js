    ...
    return (
        <>
            ...
            <div className="container d-flex justify-content-center align-items-center h-75">
                <Wordle lectures="verbs,adjetives,kitchen,city,room" onSendData={handleChildData} />
            </div>
            {
                (send || level >= 39) && (
                    <div className="m-auto">
                        <a href="/lectures/intermediate/es/test-3" className='text-center btn btn-success'>Continuar</a>
                    </div>
                )
            }
        </>
