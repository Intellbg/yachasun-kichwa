"use client"
import lectureQuestions from '../lectures_intermedio/lectureQuestions'
import lectures from '../lectures_intermedio/data'
...
export default function MiniTestForm({ lecture }) {
    ...
    return (
        <div className="container">
            ...
            <a href={`/lectures_intermedio/es/${lectureData.next}`} className={`text-center btn btn-success ${isAnswerCorrect ? "" : "d-none"}`}>Continuar</a>
        </div >
    );
}
